...
const eventImages=[
  ...
  "https://jovoindia.com/images/events/event-2.jpg",
   ...
   " https://jovoindia.com/images/events/event-16.jpg",
        ...
        <div className="row g-5">
          ...
          <div className="col-12 col-md-6 position-relative">
            <div className="video-wrapper">
              ...
              <div className="video-overlay-text text-center text-white">
          ...
          <div className="col-12 col-md-6 position-relative mt-5">
            <div className="video-wrapper">
              ...
              <div className="video-gradient"></div>
              <div className="video-overlay-text text-center ">
        ...
        {eventImages.slice(0, visibleCount).map((imgUrl, index) => (
          <div className="col-md-3 mb-5" key={index}>
            <img
              ...
              alt={`event-${index}`}
              className="img-fluid"
              style={{ height: "500px", width: "530px", objectFit: "cover" }}
            />
          </div>
        ))}
      </div>
